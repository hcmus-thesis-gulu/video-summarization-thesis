...
% Your Name
\author{HOÀNG XUÂN NHẬT \hspace{5mm} 18125042 \\ NGUYỄN E RÔ \hspace{17.5mm} 18125046}

% English title of your thesis
\title{SMART INTERACTIVE RETRIEVAL OF VISUAL DATA VIA SEMANTIC UNDERSTANDING}
...
% \includepdf[pages=-]{content/appendices/ThesisProposal-V3}
% \addtocounter{page}{-4}   
...
% \texbf{Some results of this thesis are published in the following articles:} \\
\bibliographyown{references/refs}
% \bibitem{ntphat} [1] Tien-Phat Nguyen, Ba-Thinh Tran-Le, Xuan-Dang Thai, Tam V Nguyen, Minh N Do, and Minh-Triet Tran. Traffic Video Event Retrieval via Text Query using Vehicle Inter- and Intra-Attributes. (submitted to IEEE transactions on Circuits and Systems for Video Technology, under review). \\
% \bibitem{nguyen2021traffic} [1] Tien-Phat Nguyen, Ba-Thinh Tran-Le, Xuan-Dang Thai, Tam V Nguyen, Minh N Do, and Minh-Triet Tran. Traffic video event retrieval via text query using vehicle appearance and motion attributes. In {\em Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition}, pages 4165-4172, 2021. 



\includepdf[pages=-,pagecommand={}]{publication/LSC2022}
\includepdf[pages=-,pagecommand={}]{publication/VBS2022}
\includepdf[pages=-,pagecommand={}]{publication/AAAI2023}
\includepdf[pages=-,pagecommand={}]{publication/MTAP_LSC21_FIRST2}
\includepdf[pages=-,pagecommand={}]{publication/CVPRW2022}
